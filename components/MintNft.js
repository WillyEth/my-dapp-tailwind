  ...
  details: [
    {
      name: 'Features',
      items: [
        'Use the NFT as a Avatar show the cyrpot community your Pledge of Safety',
      ],
...
export default function MintNft() {
  ...
  return (
    <div>
      <div className="sm:py-15 mx-auto max-w-2xl py-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <form className="mt-6">
              ...
              <div className="sm:flex-col1 mt-10 flex">
                <button
                  type="submit"
                  disabled={true}
                  className="flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent bg-polyO5 py-3 px-8 text-base font-medium text-white hover:bg-polyO6 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 sm:w-full"
                >
                  Minting comming soon Images only placehoders
                </button>

                <button
                  type="button"
                  className="ml-4 flex items-center justify-center rounded-md py-3 px-3 text-polyO7 hover:bg-polyO8 hover:text-gray-500"
                >
                  {/* <HeartIcon
