                    ...
                    <div className="space-y-6 pb-16">
                      ...
                      <div>
                        ...
                        <dl className="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200">
                          <div className="flex justify-between py-3 text-sm font-medium">
                            ...
                            <dd className="text-center text-gray-900">{nftObject?.contractAddress}</dd>
                          </div>
                          {/* <div className="flex justify-between py-3 text-sm font-medium">
                          ...
                          <div className="flex justify-between py-3 text-sm font-medium">
                            <dt className="text-gray-500">Total Minted</dt>
                            <dd className="text-gray-900">{nftObject?.totalMinted}</dd>
                          </div>
                          <div className="flex justify-between py-3 text-sm font-medium">
                            <dt className="text-gray-500">Symbol</dt>
                            <dd className="text-gray-900">{nftObject?.symbol}</dd>
                          </div>
                          {/* <div className="flex justify-between py-3 text-sm font-medium">
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex items-center justify-between">
                          <p className="text-sm italic text-gray-500">{nftObject?.description}</p>
                          <button
                            type="button"
                          ...
                          >
                            ...
                            <span className="sr-only">{nftObject?.description}</span>
                          </button>
                        </div>
                      </div>
                      <div>
                        ...
                        {nftObject.attributes?.map((nft, index) => (
                          <ul role="list" className="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200">
                            <li key={index} className="flex items-center justify-between py-3">
                              <div className="flex items-center">
                                ...
                                /> */}
                                <p className="ml-4 text-sm font-medium text-gray-900">{nft?.trait_type}</p>
                              </div>
                              <span className="sr-only"> {nft?.trait_type}</span>
                              {/* <button
                                type="button"
                              ...
                              <div className="ml-6 rounded-md bg-white text-sm font-medium text-indigo-600">
                                {nft?.value}
                                <span className="sr-only"> {nft?.trait_type}</span>
                              </div>
                            </li>
